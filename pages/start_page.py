...
from pages.utils import log_decorator, wait_until_ok
...
class StartPage(BasePage):
    ...
    def sign_in(self, user):
        ...
        # Fill login
        self.fill_field(
            xpath=self.constants.SIGN_IN_USERNAME_FIELD_XPATH, value=user.username
        )
        self.fill_field(
            xpath=self.constants.SIGN_IN_PASSWORD_FIELD_XPATH, value=user.password
        )
        # Click button
    ...
    def verify_sign_in_error(self):
        ...
        assert (
                self.get_element_text(self.constants.SIGN_IN_LOGIN_ERROR_XPATH)
    ...
    def sign_up_and_verify(self, user):
        ...
        # Fill username
        self.fill_field(
            xpath=self.constants.SIGN_UP_USERNAME_FIELD_XPATH, value=user.username
        )
        self.fill_field(
            xpath=self.constants.SIGN_UP_EMAIL_FIELD_XPATH, value=user.email
        )
        self.fill_field(
            xpath=self.constants.SIGN_UP_PASSWORD_FIELD_XPATH, value=user.password
        )
        # Click button
